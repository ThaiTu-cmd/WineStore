package com.doan.WineStore.security.jwt;
...
public class JwtUtils {
    ...
    @Value("${app.jwt.secret:TaoThachThucChungMayDoanDuocJWTSercetKeyCuaTaoDoDoanDuocLamConChohahaha}")
    private String jwtSecret;

    @Value("${app.jwt.expiration-ms:1800000}")
    private long jwtExpirationMs;

    @Value("${app.jwt.remember-expiration-ms:86400000}")
    ...
    public String getJwtCookieName() { return JWT_COOKIE_NAME; }
